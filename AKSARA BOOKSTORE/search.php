...
<body>
	...
	<section class="content"> 
		...
		<form action="search_index.php" method="post">
			<div class="search_bar">
				<input type="text" class="form-control" name="search" placeholder="Enter title, ISBN, author, genre or year published" id="search">
	...
	<?php
		...
		echo "<br><h2 class=\"result\">Suggested</h2><br>";
